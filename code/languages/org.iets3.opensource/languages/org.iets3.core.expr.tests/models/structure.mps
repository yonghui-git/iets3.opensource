...
<model ref="r:ba7faab6-2b80-43d5-8b95-0c440665312c(org.iets3.core.expr.tests.structure)">
  ...
  <node concept="1TIwiD" id="cU4eMaqAaz">
    <property role="EcuMT" value="232516938883556003" />
    <property role="TrG5h" value="RenderExpr" />
    <property role="34LRSv" value="render" />
    <ref role="1TJDcQ" to="hm2y:6sdnDbSla17" resolve="Expression" />
    <node concept="1TJgyj" id="cU4eMaqAaT" role="1TKVEi">
      <property role="IQ2ns" value="232516938883556025" />
      <property role="20lmBu" value="aggregation" />
      <property role="20kJfa" value="expr" />
      <property role="20lbJX" value="1" />
      <ref role="20lvS9" to="hm2y:6sdnDbSla17" resolve="Expression" />
